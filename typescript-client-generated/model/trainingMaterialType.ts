...
export type TrainingMaterialType = 'INTENTREGEX' | 'INTENTOPENNLPDOCCAT' | 'VARIABLEOPENNLPNER' | 'VARIABLEOPENNLPREGEX';
...
export const TrainingMaterialType = {
    ...
    VARIABLEOPENNLPREGEX: 'VARIABLEOPENNLPREGEX' as TrainingMaterialType
};
