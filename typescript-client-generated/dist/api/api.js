...
var ApiUtils = /** @class */ (function () {
     ...
     */
    ApiUtils.getUMATicket = function (response) {
        var wwwAuthenticateHeader = response.headers ? response.headers.get("www-authenticate") : null;
        ...
        var headerComponents = wwwAuthenticateHeader.substring(4).split(",");
        headerComponents.forEach(function (component) {
            var eq = component.indexOf("=");
            var name = component.substring(0, eq);
            var value = component.substring(eq + 2, component.length - 1);
            result[name] = value;
        });
        return result;
    };
     ...
     * @returns RPT token
     **/
    ApiUtils.getRPT = function (authorization, ticket) { return __awaiter(_this, void 0, void 0, function () {
        var url, body, headers;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    url = ticket.as_uri + "/protocol/openid-connect/token";
