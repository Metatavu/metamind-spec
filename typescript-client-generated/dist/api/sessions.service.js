...
var SessionsService = /** @class */ (function () {
    ...
    */
    SessionsService.prototype.createSession = function (body, storyId, retrying) {
        return __awaiter(this, void 0, void 0, function () {
            var uri, options, response, ticket, authorization, rptToken;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        uri = new URI(this.basePath + "/stories/" + encodeURIComponent(String(storyId)) + "/sessions");
                        options = {
                            method: "post",
                            headers: {
                    ...
                    case 2:
                        ...
                        if (this.rptToken) {
                            return [2 /*return*/, this.createSession(body, storyId, true)];
                        }
                        _a.label = 3;
