module.exports = function(grunt) {
  ...
  const JAXRS_ARTIFACT = "metamind-api-spec";
  const JAXRS_PACKAGE = "fi.metatavu.metamind.rest";
  ...
  grunt.initConfig({
    ...
    "shell": {
      ...
      "jaxrs-fix-folders": {
        command : "mkdir -p jaxrs-spec-generated/src/main/java/fi/metatavu/metamind/rest && mv jaxrs-spec-generated/src/main/java/io/swagger/* jaxrs-spec-generated/src/main/java/fi/metatavu/metamind/rest"
      },
      "jaxrs-spec-install": {
        command : "mvn install",
        options: {
